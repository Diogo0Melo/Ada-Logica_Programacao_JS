...
const parceirosAgrupados = { PF: [ { parceirosId: '12345678901', nome: 'Carlos Antonio' }, { parceirosId: '12345678901', nome: 'Informática' }, ], PJ: [ { parceirosId: '12345678901234', nome: 'Empresa Xpto Ltda.' }, { parceirosId: '12345678901235', nome: 'Construtora' }, ] }
...
const listaOrganizada = {}, listaPF = [] , listaPJ = []
listaParceiros.map(item => item.parceirosId.length == 11 ? listaPF.push(item) : listaPJ.push(item))
listaOrganizada.PF = listaPF, listaOrganizada.PJ = listaPJ
